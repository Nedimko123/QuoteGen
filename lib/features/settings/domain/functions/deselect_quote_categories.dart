...
Future<void> deselectQuoteCategories(WidgetRef ref) async {
  final SharedPreferences sharedPreferences =
      await SharedPreferences.getInstance();

  sharedPreferences.setString(sharedPreferencesQuoteCategoryKey,
      jsonEncode(defaultUnselectedCategories));
